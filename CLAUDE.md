- ALWAYS. when writing code, always open up a new git branch and ALWAYS create a pull request when you are done. a human or another ai will evaluate the pull request before adding it to the main branch
